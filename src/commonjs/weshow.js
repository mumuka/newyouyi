...
WeShow.prototype.mfun = function(e) {
	...
	var prey=parseInt(-_this.mainh)+dy;
	var nexty=parseInt(_this.mainh)+dy;
	$(".prebox").css({"-webkit-transform":"translate3d(0px,"+prey+"px,0px)"});
	$(".nextbox").css({"-webkit-transform":"translate3d(0px,"+nexty+"px,0px)"});
	// $(".current").css({"-webkit-transform":" translate3d(0px,"+dy+"px,0px)"});
...
WeShow.prototype.endfun = function(e) {
	...
	switch(this.mchange){
		case 1:
			$(".prebox").css({"-webkit-transform":"translate3d(0px,0px,0px)","-webkit-transition":"all 0.4s ease-out"});
			$(".current").css({"-webkit-transform":" translate3d(0px,1px,0px)","-webkit-transition":"all 0.4s ease-out"});
        	_this.touchcontrol=false;
			_this.maini--;
		break;
		case 2:
			$(".nextbox").css({"-webkit-transform":"translate3d(0px,0px,0px)","-webkit-transition":"all 0.4s ease-out"});
			$(".current").css({"-webkit-transform":" translate3d(0px,-1px,0px)","-webkit-transition":"all 0.4s ease-out"});
			_this.touchcontrol=false;
			_this.maini++;
		break;
		default:
			$(".prebox").css({"-webkit-transform":"translate3d(0px,-"+_this.mainh+"px,0px)","-webkit-transition":"all 0.2s ease-out"});
			$(".nextbox").css({"-webkit-transform":"translate3d(0px,"+_this.mainh+"px,0px)","-webkit-transition":"all 0.2s ease-out"});
			$(".current").css({"-webkit-transform":" translate3d(0px,0px,0px)","-webkit-transition":"all 0.2s ease-out"});
			_this.touchcontrol=true;
	}
...
WeShow.prototype.classinit = function() {
	...
	_this.loadimg(maini+2);
	_this.loadimg(maini+3);
	//更新位置，翻页动画
	// _this.container.children().each(function(index){
	// 	$(this).attr("style","")
	...
	_this.container.children().each(function(index){
		if($(this).hasClass("current")){
			$(this).css({"-webkit-transform":" translate3d(0px,0px,0px)","-webkit-transition":"0s ease-out"});
		}else if($(this).hasClass("prebox")){
			$(this).css({"-webkit-transform":" translate3d(0px,-"+_this.mainh+"px,0px)","-webkit-transition":"0s ease-out"});
		}else if($(this).hasClass("nextbox")){
			$(this).css({"-webkit-transform":" translate3d(0px,"+_this.mainh+"px,0px)","-webkit-transition":"0s ease-out"});
		}else{
			$(this).css({"-webkit-transform":" translate3d(0px,"+_this.mainh+"px,0px)","-webkit-transition":"0s ease-out"});
		}
